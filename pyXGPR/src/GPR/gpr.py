...
def gp_pred(logtheta, covfunc, X, y, Xstar, R=None, w=None, Rstar=None, wind=None):
    if R==None: 
        print '        gp_pred()'
    #else:
    #    print '        xgp_pred()'
    ...
    if R==None:
        ...
        [Kss, Kstar] = feval(covfunc, logtheta, X, Xstar, y, wind)   # test covariances (Kss = self covariances, Kstar = cov between train and test cases)
    else:
